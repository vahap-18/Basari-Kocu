...
function getHistoryForToday() {
  ...
  return (
    HISTORY_MAP[key] ?? [
      "Bugün tarihte önemli bir olay kaydedilmemiş. Ancak her gün öğrenmek için bir fırsattır.",
    ]
  );
}
  ...
  return (
    <Card className="animate-pop">
      ...
      <div className="mt-3 flex items-center gap-2">
        ...
        >
          Tüm tekniklere gözat
        </Link>
        <Link to="/teknikler" className="text-sm text-muted-foreground">
          Detaylı rehber
        </Link>
      </div>
    </Card>
  ...
  return (
    <Card className="animate-fade-in">
      ...
      <div className="flex items-center gap-3">
        <img
          src="https://media.giphy.com/media/l0HlJz2s5k0s7b9Wk/giphy.gif"
          alt="uplift"
