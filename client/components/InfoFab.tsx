        ...
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-card rounded-2xl border p-4 z-10">
            ...
            <div className="text-sm space-y-2">
              <p>Bu bir Acodex Academy projesidir. A. Vahap Doğan tarafından geliştirilmiştir.</p>
              <p>Projeye ve sosyal hesaplara buradan ulaşabilirsiniz:</p>
              <ul className="list-disc pl-5">
                <li><a href="https://linktr.ee/acodex" target="_blank" rel="noreferrer" className="text-primary">Acodex Linktree</a></li>
              </ul>
              <div className="mt-3 text-xs text-muted-foreground">© Acodex Academy</div>
            </div>
          </div>
        </div>
      )}
